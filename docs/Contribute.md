# Contributing to Lychee AI Vision
...
1. Clone the repository:
    ```bash
    git clone https://github.com/YOUR_USERNAME/Lychee-Facial-Recognition.git
...
- **Python 3.12+** — use modern syntax and type hints throughout
...
- Ensure all quality checks pass (`ruff check`, `ty check`, `pytest`)
...
- Review the [documentation structure](.) to understand how the project is organized
